...
(function () {
  ...
  const DICT = {
    ...
    about: {
      ...
      p1_bio: { en: "With TEPIA since 2019. Oversees candidate intake at the Warsaw office and personally reviews every employer before a vacancy goes live.", uk: "У TEPIA з 2019 року. Керує прийомом кандидатів у варшавському офісі та особисто перевіряє кожного роботодавця перед публікацією вакансії.", de: "Bei TEPIA seit 2019. Überwacht die Kandidatenaufnahme im Warschauer Büro und prüft jeden Arbeitgeber persönlich, bevor eine Stelle veröffentlicht wird.", ro: "La TEPIA din 2019. Supraveghează primirea candidaților la biroul din Varșovia și verifică personal fiecare angajator înainte de publicarea unui loc de muncă.", ru: "В TEPIA с 2019 года. Руководит приёмом кандидатов в варшавском офисе и лично проверяет каждого работодателя перед публикацией вакансии." },
      p1_quote: { en: "I like that I get to talk to someone new every day — and that a phone call from me usually means good news.", uk: "Мені подобається щодня спілкуватися з кимось новим — і те, що дзвінок від мене зазвичай означає хороші новини.", de: "Mir gefällt, dass ich jeden Tag mit jemandem Neuem spreche — und dass ein Anruf von mir meist gute Nachrichten bedeutet.", ro: "Îmi place că vorbesc cu cineva nou în fiecare zi — și că un apel de la mine înseamnă de obicei vești bune.", ru: "Мне нравится каждый день общаться с кем-то новым — и то, что звонок от меня обычно означает хорошие новости." },
      ...
      p2_bio: { en: "Handles work permit paperwork for the Wrocław and Kraków regions. Five years of experience navigating Polish immigration procedures.", uk: "Веде оформлення дозволів на роботу для регіонів Вроцлава і Кракова. П'ять років досвіду в польських імміграційних процедурах.", de: "Kümmert sich um Arbeitserlaubnisunterlagen für die Regionen Breslau und Krakau. Fünf Jahre Erfahrung mit polnischen Einwanderungsverfahren.", ro: "Se ocupă de actele pentru permisul de muncă pentru regiunile Wrocław și Cracovia. Cinci ani de experiență cu procedurile de imigrare poloneze.", ru: "Ведёт оформление разрешений на работу для регионов Вроцлава и Кракова. Пять лет опыта в польских иммиграционных процедурах." },
      p2_quote: { en: "Most people are more worried about the paperwork than they need to be. That's the part I actually enjoy solving.", uk: "Більшість людей хвилюються через документи більше, ніж потрібно. Саме цю частину я і люблю вирішувати.", de: "Die meisten Menschen machen sich mehr Sorgen um den Papierkram, als nötig ist. Genau das löse ich am liebsten.", ro: "Majoritatea oamenilor se îngrijorează mai mult decât trebuie din cauza actelor. Asta e partea care îmi place să o rezolv.", ru: "Большинство людей волнуются из-за документов больше, чем нужно. Именно эту часть я и люблю решать." },
      ...
      p3_bio: { en: "The first call most candidates get after landing in Poland. Coordinates housing, transport and any questions during the first weeks.", uk: "Перший дзвінок, який отримує більшість кандидатів після прибуття в Польщу. Координує житло, транспорт і будь-які питання в перші тижні.", de: "Der erste Anruf, den die meisten Kandidaten nach der Ankunft in Polen erhalten. Koordiniert Unterkunft, Transport und alle Fragen in den ersten Wochen.", ro: "Primul apel pe care majoritatea candidaților îl primesc după ce aterizează în Polonia. Coordonează cazarea, transportul și orice întrebări în primele săptămâni.", ru: "Первый звонок, который получает большинство кандидатов после прибытия в Польшу. Координирует жильё, транспорт и любые вопросы в первые недели." },
      p3_quote: { en: "I remember what it's like to arrive somewhere new and not know anyone. I try to be the person I wish I'd had.", uk: "Я пам'ятаю, як це — приїхати кудись і нікого не знати. Намагаюся бути тим, кого мені самій бракувало.", de: "Ich weiß noch, wie es ist, irgendwo neu anzukommen und niemanden zu kennen. Ich versuche, die Person zu sein, die ich mir gewünscht hätte.", ro: "Îmi amintesc cum e să ajungi undeva nou și să nu cunoști pe nimeni. Încerc să fiu persoana pe care mi-aș fi dorit-o eu.", ru: "Я помню, каково это — приехать куда-то и никого не знать. Стараюсь быть тем человеком, которого мне самой не хватало." },
    ...
    vacPage: {
      ...
      filterCountry: { en: "Country", uk: "Країна", de: "Land", ro: "Țară", ru: "Страна" },
      filterGender: { en: "Gender", uk: "Стать", de: "Geschlecht", ro: "Gen", ru: "Пол" },
      genderAny: { en: "Any", uk: "Будь-яка", de: "Beliebig", ro: "Oricare", ru: "Любой" },
      genderMale: { en: "Male", uk: "Чоловіча", de: "Männlich", ro: "Masculin", ru: "Мужской" },
      genderFemale: { en: "Female", uk: "Жіноча", de: "Weiblich", ro: "Feminin", ru: "Женский" },
      filterHousing: { en: "Housing provided", uk: "Житло надається", de: "Unterkunft vorhanden", ro: "Cazare oferită", ru: "Жильё предоставляется" },
      clearFilters: { en: "Reset filters", uk: "Скинути фільтри", de: "Filter zurücksetzen", ro: "Resetează filtrele", ru: "Сбросить фильтры" },
      noResults: { en: "No vacancies match these filters. Try widening your search.", uk: "Жодна вакансія не відповідає фільтрам. Спробуйте розширити пошук.", de: "Keine Stellen entsprechen diesen Filtern. Erweitern Sie Ihre Suche.", ro: "Niciun loc de muncă nu corespunde acestor filtre. Încearcă să lărgești căutarea.", ru: "Ни одна вакансия не соответствует фильтрам. Попробуйте расширить поиск." },
      resultsCount: { en: "{n} vacancies found", uk: "Знайдено вакансій: {n}", de: "{n} Stellen gefunden", ro: "{n} locuri de muncă găsite", ru: "Найдено вакансий: {n}" },
    },
    vacDetail: {
      ...
      salary: { en: "6,100–8,200 PLN gross / month", uk: "6 100–8 200 zł брутто / місяць", de: "6.100–8.200 PLN brutto / Monat", ro: "6.100–8.200 PLN brut / lună", ru: "6 100–8 200 zł брутто / месяц" },
      housingVal: { en: "20 PLN/day, deducted from salary", uk: "20 zł/доба, з утриманням із зарплати", de: "20 PLN/Tag, vom Lohn abgezogen", ro: "20 PLN/zi, dedus din salariu", ru: "20 zł/сутки, с удержанием из зарплаты" },
      genderVal: { en: "Any", uk: "Будь-яка", de: "Beliebig", ro: "Oricare", ru: "Любой" },
      bonus1: { en: "Free transport to work", uk: "Безкоштовний трансфер до роботи", de: "Kostenloser Transport zur Arbeit", ro: "Transport gratuit la locul de muncă", ru: "Бесплатный трансфер до работы" },
      bonus2: { en: "Housing compensation available", uk: "Можлива компенсація за житло", de: "Wohnkostenzuschuss verfügbar", ro: "Compensare pentru cazare disponibilă", ru: "Возможна компенсация за жильё" },
    },
    blogPage: {
    ...
    quiz: {
      title: { en: "Answer 3 quick questions — we'll match a vacancy for you", uk: "Дайте відповідь на 3 короткі питання — ми підберемо вакансію", de: "Beantworten Sie 3 kurze Fragen — wir finden eine passende Stelle", ro: "Răspunde la 3 întrebări scurte — îți găsim un loc de muncă", ru: "Ответьте на 3 коротких вопроса — мы подберём вакансию" },
      step1_q: { en: "I'm looking for a job for:", uk: "Я шукаю вакансію для:", de: "Ich suche eine Stelle für:", ro: "Caut un loc de muncă pentru:", ru: "Я ищу вакансию для:" },
      opt_man: { en: "A man", uk: "Чоловіка", de: "Einen Mann", ro: "Un bărbat", ru: "Мужчины" },
      opt_woman: { en: "A woman", uk: "Жінку", de: "Eine Frau", ro: "O femeie", ru: "Женщины" },
      opt_couple: { en: "A couple", uk: "Пару", de: "Ein Paar", ro: "Un cuplu", ru: "Пару" },
      step2_q: { en: "I'm currently in:", uk: "Я знаходжусь:", de: "Ich befinde mich in:", ro: "Mă aflu în:", ru: "Я нахожусь:" },
      opt_poland: { en: "Poland", uk: "Польщі", de: "Polen", ro: "Polonia", ru: "Польше" },
      opt_ukraine: { en: "Ukraine", uk: "Україні", de: "Ukraine", ro: "Ucraina", ru: "Украине" },
      opt_other: { en: "Another country", uk: "Іншій країні", de: "Einem anderen Land", ro: "O altă țară", ru: "Другой стране" },
      step3_q: { en: "My contact details:", uk: "Мої контакти:", de: "Meine Kontaktdaten:", ro: "Datele mele de contact:", ru: "Мои контакты:" },
      back: { en: "< Back", uk: "< Назад", de: "< Zurück", ro: "< Înapoi", ru: "< Назад" },
      next: { en: "Next >", uk: "Далі >", de: "Weiter >", ro: "Continuă >", ru: "Далее >" },
      submit: { en: "Get matched >", uk: "Зв'язатися >", de: "Verbinden >", ro: "Contactează-mă >", ru: "Связаться >" },
    },
    hotvac: {
      eyebrow: { en: "Urgent Vacancies", uk: "Гарячі вакансії", de: "Dringende Stellen", ro: "Locuri de muncă urgente", ru: "Горячие вакансии" },
      title: { en: "Roles we need to fill this week", uk: "Вакансії, які потрібно закрити цього тижня", de: "Stellen, die wir diese Woche besetzen müssen", ro: "Poziții pe care trebuie să le ocupăm săptămâna aceasta", ru: "Вакансии, которые нужно закрыть на этой неделе" },
      loc: { en: "Location", uk: "Місце", de: "Ort", ro: "Locație", ru: "Место" },
      salary: { en: "Salary", uk: "Зарплата", de: "Gehalt", ro: "Salariu", ru: "Зарплата" },
      housing: { en: "Housing", uk: "Житло", de: "Unterkunft", ro: "Cazare", ru: "Жильё" },
      v1_title: { en: "Warehouse Packer — French Grocery Chain", uk: "Пакувальник на складі французької продуктової мережі", de: "Lagerpacker — Französische Lebensmittelkette", ro: "Ambalator depozit — Lanț alimentar francez", ru: "Упаковщик склада французской продуктовой сети" },
      v1_loc: { en: "Wrocław area, Poland", uk: "Околиці Вроцлава, Польща", de: "Raum Breslau, Polen", ro: "Zona Wrocław, Polonia", ru: "Окрестности Вроцлава, Польша" },
      v1_salary: { en: "from 6,100 PLN gross", uk: "від 6 100 zł брутто", de: "ab 6.100 PLN brutto", ro: "de la 6.100 PLN brut", ru: "от 6 100 zł брутто" },
      v1_housing: { en: "20 PLN/day", uk: "20 zł/доба", de: "20 PLN/Tag", ro: "20 PLN/zi", ru: "20 zł/сутки" },
      v2_title: { en: "Ready-Meal Production Operator", uk: "Оператор виробництва готових обідів", de: "Bediener für Fertiggerichte-Produktion", ro: "Operator producție mâncare gata preparată", ru: "Оператор производства готовых обедов" },
      v2_loc: { en: "Zawiercie, Poland", uk: "Заверче, Польща", de: "Zawiercie, Polen", ro: "Zawiercie, Polonia", ru: "Заверце, Польша" },
      v2_salary: { en: "from 6,500 PLN gross", uk: "від 6 500 zł брутто", de: "ab 6.500 PLN brutto", ro: "de la 6.500 PLN brut", ru: "от 6 500 zł брутто" },
      v2_housing: { en: "from 450 PLN/month", uk: "від 450 zł/місяць", de: "ab 450 PLN/Monat", ro: "de la 450 PLN/lună", ru: "от 450 zł/месяц" },
      apply: { en: "Details", uk: "Деталі", de: "Details", ro: "Detalii", ru: "Детали" },
      all: { en: "All urgent vacancies", uk: "Усі гарячі вакансії", de: "Alle dringenden Stellen", ro: "Toate locurile urgente", ru: "Все горячие вакансии" },
    },
    officesStrip: {
      eyebrow: { en: "Our Offices", uk: "Наші відділи", de: "Unsere Büros", ro: "Birourile noastre", ru: "Наши отделы" },
      title: { en: "Drop by in person in five Polish cities", uk: "Завітайте особисто в п'яти містах Польщі", de: "Besuchen Sie uns persönlich in fünf polnischen Städten", ro: "Vino personal în cinci orașe poloneze", ru: "Загляните лично в пяти городах Польши" },
    },
    ctaBanner: {
      title: { en: "Find a vacancy with TEPIA and start working now", uk: "Шукай вакансію з TEPIA та почни працювати вже зараз", de: "Finden Sie mit TEPIA eine Stelle und beginnen Sie jetzt zu arbeiten", ro: "Găsește un loc de muncă cu TEPIA și începe să lucrezi acum", ru: "Найди вакансию с TEPIA и начни работать уже сейчас" },
      text: { en: "Free service for candidates. No hidden fees, ever.", uk: "Безкоштовна послуга для кандидатів. Жодних прихованих комісій.", de: "Kostenloser Service für Kandidaten. Niemals versteckte Gebühren.", ro: "Serviciu gratuit pentru candidați. Niciodată taxe ascunse.", ru: "Бесплатная услуга для кандидатов. Никаких скрытых комиссий." },
      cta: { en: "Find a vacancy", uk: "Підібрати вакансію", de: "Stelle finden", ro: "Găsește un loc de muncă", ru: "Подобрать вакансию" },
    },
    cookie: {
